            ...
            <div className="flex flex-col items-center justify-center p-6 border-2 border-dashed rounded-lg border-muted bg-card hover:bg-muted/50 transition-colors">
                {imagePreview ? (
                    ...
                    <div className="text-center">
                        ...
                        <p className="mt-2 font-semibold text-primary">Nhấp để tải ảnh lên</p>
        ...
        {featureCards.map(card => {
            ...
            return (
                <Card 
                    ...
                    className={cn(
                        "cursor-pointer transition-all duration-300 hover:shadow-xl hover:border-primary/50",
                ...
                >
                    <CardHeader className="items-center text-center p-4 md:p-6">
                        <div className={cn(
                            "mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 text-primary transition-colors",
